<%@ Page Title="" Language="C#" MasterPageFile="~/FundRaiser/Login.Master" AutoEventWireup="true" CodeBehind="FundRaisersLogIn.aspx.cs" Inherits="OCR.FundRaiser.FundRaisersLogIn" %>
...
<%--     <asp:TextBox ID="txtPassword" runat="server" placeholder="Enter your password" TextMode="Password"></asp:TextBox>
            ...
            <div class="switch">Don't have an account? <a href="FundRegistration.aspx" onclick="switchCard()">Register here</a></div>
        </div>
    </div>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <style>
        /* Modern CSS for Fundraiser Login - no TailwindCSS conflicts */
        ...
        .login-button {
            width: 100%;
            padding: 18px;
            /*background: linear-gradient(135deg, #f85a40, #1f76bd);*/
            background: linear-gradient(135deg, #667eea, #764ba2);
            color: white;
            border: none;
            border-radius: 15px;
            ...
            cursor: pointer;
            transition: all 0.3s ease;
            box-shadow: 0 10px 30px rgba(248, 90, 64, 0.3);
            text-transform: uppercase;
            letter-spacing: 1px;
            margin-top: 10px;
        }
        ...
        .login-button:hover {
            ...
            box-shadow: 0 15px 40px rgba(248, 90, 64, 0.4);
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="fundraiser-login-page">
        <div class="login-container">
            <div class="login-card fade-in-up">
                ...
                <div class="login-header">
                    ...
                    <h2 class="login-title">Fundraiser Login</h2>
                    <p class="login-subtitle">Access your account to manage campaigns</p>
                </div>
                ...
                <div class="switch-section">
                    ...
                    <a href="FundRegistration.aspx" class="switch-link">Register here</a>
                </div>
            </div>
        </div>
    </div>
