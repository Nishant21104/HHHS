...
namespace OCR.NGO
{
    public partial class ChangePassword : System.Web.UI.Page
    {
        ...
        //    str = "select count(*) from tbl_NGORegistration where UserName=@UserName and Password =@Password";
        ...
        protected void btnVerify_Click(object sender, EventArgs e)
        {
            using (SqlConnection con = new SqlConnection(strConnString))
            {
                ...
                SqlCommand cmd = new SqlCommand(
                    "SELECT COUNT(*) FROM tbl_NgoRegistration WHERE UserName=@UserName AND Password=@Password",
                    con);
        ...
        protected void btnChangePassword_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(strConnString))
            {
                ...
                SqlCommand cmd = new SqlCommand(
                    "UPDATE tbl_NgoRegistration SET Password=@NewPassword WHERE UserName=@UserName",
                    con);
            ...
            ClientScript.RegisterStartupScript(this.GetType(), "pwdChanged", "alert('Password updated successfully'); window.location='NGOHome.aspx';", true);
