<%@ Page Title="" Language="C#" MasterPageFile="~/NGO/Login.Master" AutoEventWireup="true" CodeBehind="NGOLogin.aspx.cs" Inherits="OCR.NGO.NGOLogin" %>
...
<%--            <asp:TextBox ID="txtPassword" runat="server" placeholder="Enter your password" TextMode="Password"></asp:TextBox>
            ...
            <div class="switch">Don't have an account? <a href="NGORegistration.aspx" onclick="switchCard()">Register here</a></div>
        </div>
    </div>
        ...
        <div class="login-container">
            <div class="login-card fade-in-up">
                ...
                <div class="switch-section">
                    ...
                    <a href="NGORegistration.aspx" class="switch-link">Register here</a>
                </div>

                <div class="switch-section2">
                    <span class="switch-text"></span>
                    <a href="VerifyNgoEmail.aspx" class="switch-link">VeriFy Email here</a>
                </div>
            </div>
        </div>
    </div>
