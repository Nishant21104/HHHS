<%@ Page Title="" Language="C#" MasterPageFile="~/Home/Home.Master" AutoEventWireup="true" CodeBehind="StaffLogin.aspx.cs" Inherits="OCR.Admin.StaffLogin" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <style>
        /* Modern CSS for Staff Login - no TailwindCSS conflicts */
        .staff-login-page {
        ...
        <div class="login-container">
            <div class="login-card fade-in-up">
                ...
                <div class="login-header">
                    ...
                    <p class="login-subtitle">Access your administrative dashboard</p>
                </div>
