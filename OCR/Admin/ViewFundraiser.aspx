<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ViewFundraiser.aspx.cs" Inherits="OCR.Admin.ViewFundraiser" %>

<%--<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="jumbotron" style="margin-left: 25px; margin-right: 25px;">
        <h3>Fundraiser List</h3>
    </div>
    <div class="row" style="margin-left: 25px; margin-right: 25px;">
        <div class="col-lg-12 ">
            <div class="table-responsive">
                <asp:GridView ID="grdFundRaiser" runat="server" Width="100%" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" DataKeyNames="ID" EmptyDataText="There are no data records to display.">
                    <Columns>
                        ...
                        <asp:BoundField DataField="StartDate" HeaderText="Start Date" HeaderStyle-CssClass="visible-xs" ItemStyle-CssClass="visible-xs" />
                        <asp:BoundField DataField="EndDate" HeaderText="End Date" HeaderStyle-CssClass="visible-xs" ItemStyle-CssClass="visible-xs" />
                        <asp:BoundField DataField="Description" HeaderText="Description" HeaderStyle-CssClass="visible-xs" ItemStyle-CssClass="visible-xs" />
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style>
        /* Modern CSS for Fundraiser View - no TailwindCSS conflicts */
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="fundraiser-view-page">
        <div class="page-header">
            <h3 class="page-title">Fundraiser Management</h3>
        </div>
        
        <div class="content-container">
            <div class="table-responsive">
                <asp:GridView ID="grdFundRaiser" runat="server" Width="100%" 
